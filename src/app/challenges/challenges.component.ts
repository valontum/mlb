...
export class ChallengesComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    this._http.get('http://http://176.9.157.103:4000/api/challenges').subscribe((data) => {
  ...
  postLike(postId, id)
  {
    ...
    if(this.authService.isAuthenticated().status) {
      ...
      this._http.put('http://http://176.9.157.103:4000/api/like/' + postId, formData, options).subscribe((data) => {
  ...
  unLike(postId, id)
  {
    ...
    if(this.authService.isAuthenticated().status) {
      ...
      this._http.put('http://http://176.9.157.103:4000/api/unlike/' + postId, formData, options).subscribe((data) => {
