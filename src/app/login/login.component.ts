...
export class LoginComponent implements OnInit {
  ...
  login()
  {
    ...
    else
    {
      ...
      this._http.post('http://http://176.9.157.103:4000/api/authenticate', formData,{headers:headers}).subscribe((data) => {
    ...
    else
    {
      ...
      }else
      {
        ...
        }else
        {
          ...
          this._http.post('http://http://176.9.157.103:4000/api/register', formData,{headers:headers}).subscribe((data) => {
