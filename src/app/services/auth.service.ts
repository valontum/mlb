...
export class AuthService {
  ...
  getNotifications()
  {
    ...
    return  this._http.get('http://176.9.157.103:80/api/notificationsstatus/'+this.user.id,{headers:headers});
  ...
  signOut()
  {
    ...
    this._http.get('http://176.9.157.103:80/api/logout',{headers:headers}).subscribe((data) => {
