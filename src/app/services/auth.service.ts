...
export class AuthService {
  ...
  getNotifications()
  {
    ...
    return  this._http.get('http://localhost:4000/api/notificationsstatus/'+this.user.id,{headers:headers});
  ...
  signOut()
  {
    ...
    this._http.get('http://localhost:4000/api/logout',{headers:headers}).subscribe((data) => {
