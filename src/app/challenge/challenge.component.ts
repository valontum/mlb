...
export class ChallengeComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    this.sub = this.route.params.subscribe(params => {
      ...
      {
        this._http.get('http://localhost:4000/api/challenge/'+params['id']).subscribe((data) => {
  ...
  postSolution()
  {
    ...
    if(this.authService.isAuthenticated().status) {
      ...
      if (this.data.solution != "") {
        ...
        this._http.put('http://localhost:4000/api/ideas/' + this.challenge.id, formData, options).subscribe((data) => {
  ...
  postQuestion()
  {
    ...
    if(this.authService.isAuthenticated().status) {
      ...
      if (this.data.question != "") {
        ...
        this._http.put('http://localhost:4000/api/question/' + this.challenge.id, formData, options).subscribe((data) => {
  ...
  postLike(ideaId, id)
  {
    ...
    if(this.authService.isAuthenticated().status) {
      ...
      this._http.put('http://localhost:4000/api/idealike/' + this.challenge.id, formData, options).subscribe((data) => {
  ...
  unLike(ideaId, id)
  {
    ...
    if(this.authService.isAuthenticated().status) {
      ...
      this._http.put('http://localhost:4000/api/unlikeidea/' + this.challenge.id, formData, options).subscribe((data) => {
...
// remove object
  ...
  postLikeQ(ideaId, id)
  {
    ...
    if(this.authService.isAuthenticated().status) {
      ...
      this._http.put('http://localhost:4000/api/questionlike/' + this.challenge.id, formData, options).subscribe((data) => {
  ...
  unLikeQ(ideaId, id)
  {
    ...
    if(this.authService.isAuthenticated().status) {
      ...
      this._http.put('http://localhost:4000/api/unlikequestion/' + this.challenge.id, formData, options).subscribe((data) => {
